...
import com.example.testandroid.pagingridview.FooterViewGridAdapter;
import com.example.testandroid.pagingridview.PagingGridView;

public class CustomPagingGirdViewActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_paging_gridview);
