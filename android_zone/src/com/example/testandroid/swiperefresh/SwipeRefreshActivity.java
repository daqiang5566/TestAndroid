...
public class SwipeRefreshActivity extends ActionBarActivity implements SwipyRefreshLayout.OnRefreshListener, View.OnClickListener {
        ...
        switch (v.getId()) {
            ...
            case R.id.button_refresh:
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        //Hide the refresh after 2sec
                        SwipeRefreshActivity.this.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
