package com.example.testandroid.countdowview;
...
public class CountdownView extends View {
    ...
    private void initTimeBgRect() {
        if (!isHideTimeBackground) {
            ...
            mTimeTextBaseY = mMinuteBgRectF.top + (mMinuteBgRectF.bottom - mMinuteBgRectF.top - timeFontMetrics.bottom + timeFontMetrics.top) / 2 - timeFontMetrics.top - mTimeTextBottom;

            // initialize background division line y point
            mTimeBgDivisionLineYPos = mMinuteBgRectF.centerY() + (mTimeBgDivisionLineSize == dp2px(DEFAULT_TIME_BG_DIVISION_LINE_SIZE) ? mTimeBgDivisionLineSize : mTimeBgDivisionLineSize / 2);
        }
    }
